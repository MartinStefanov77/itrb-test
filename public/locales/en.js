export const LOCALE_EN = {
  ...
  "careers.list.heading": "Open positions",
  "careers.listEmpty": "No positions match your filters.",
  ...
  "careers.filter.city": "City",
  "careers.filter.department": "Department",
  "careers.filter.search": "Search",
  "careers.filter.searchPlaceholder": "Search by job title…",
  "careers.filter.all": "All",
  "careers.filter.city.sofia": "Sofia",
  "careers.filter.dept.administration": "Administration",
  "careers.filter.dept.finance": "Finance",
  "careers.filter.dept.humanResources": "Human Resources",
  "careers.filter.clearCity": "Clear city filter",
  "careers.filter.clearDepartment": "Clear department filter",
  "careers.filter.clearSearch": "Clear search",
  "careers.card.viewDetails": "View details",
  "careers.applyBtn": "Apply",
  "careers.backToList": "← All open positions",

  "careers.j1.cardTitle": "Office Receptionist",
  "careers.j1.cardLine1": "<strong>Location:</strong> Sofia, Bulgaria",
  "careers.j1.detailTitle": "Office Receptionist",
  ...
  "careers.j2.cardTitle": "Accountant",
  "careers.j2.cardLine1": "<strong>Location:</strong> Sofia, Bulgaria",
  "careers.j2.detailTitle": "Accountant",
  "careers.j2.detailMeta": "Sofia, Bulgaria · Standard working hours · ASAP",
  "careers.j2.resp":
  ...
  "careers.j3.cardTitle": "HR Associate",
  "careers.j3.cardLine1": "<strong>Location:</strong> Sofia, Bulgaria",

  "careers.detail.tabJob": "Job",
  "careers.detail.tabApply": "Apply",
  "careers.section.responsibilities": "Your role",
  "careers.section.requirements": "Requirements",
  "careers.section.offer": "What we offer",
  ...
  "wwa.industries.i4": "SaaS & technology platforms",
  ...
  "wwa.cert.c4.title": "ISO 37001 — Anti-bribery management systems",
  "wwa.cert.a11y.close": "Close certificate viewer",
  "wwa.cert.a11y.prev": "Previous certificate",
  "wwa.cert.a11y.next": "Next certificate",
  "wwa.cert.thumbsGroup": "Certificate thumbnails — select to view",
  ...
  "srv.s1.li6": "Development of high-level and low-level architectures",
  ...
  "srv.s2.li5": "Private cloud environments",
  ...
  "srv.s3.sub1.li3": "Multi-cloud integrations",
  ...
  "srv.s4.sub1.li3": "SD-WAN deployment",
  "srv.s4.sub1.li4": "Secure VPN and encrypted tunnels",
  "srv.s4.sub1.li5": "International connectivity and transit routing",
  "srv.s4.sub1.li6": "Data Center Interconnect (DCI)",
  "srv.s4.sub1.li7": "MPLS integrations",
  "srv.s4.sub2.title": "Advanced network services for complex environments",
  "srv.s4.sub2.li1": "Traffic optimization for latency-sensitive applications",
  "srv.s4.sub2.li2": "Geo-restriction and controlled access policies",
  "srv.s4.sub2.li3": "Geo-IP filtering",
  "srv.s4.sub2.li4": "Cross-border data transfer control",
  ...
  "srv.s5.li3": "Offsite and cloud replication",
  "srv.s5.li4": "Disaster Recovery architecture and testing",
  "srv.s5.li5": "RPO and RTO definition",
  "srv.s5.li6": "Backup encryption and ransomware protection",
  ...
  "srv.s6.li3": "Infrastructure hardening",
  "srv.s6.li4": "Vulnerability assessments",
  "srv.s6.li5": "Network segmentation and zero-trust architecture",
  "srv.s6.li6": "Logging and monitoring frameworks",
  ...
  "srv.s7.li3": "On-call engineering teams",
  "srv.s7.li4": "Critical incident response",
  "srv.s7.li5": "Patch and lifecycle management",
  ...
  "srv.s8.li3": "API integrations",
  "srv.s8.li4": "UI/UX design",
  ...
  "srv.s9.sub1.li3": "Vendor coordination",
  "srv.s9.sub1.li4": "Acceptance procedures",
  "srv.s9.sub2.title": "Account Management",
  "srv.s9.sub2.li1": "Strategic client management",
  "srv.s9.sub2.li2": "Long-term technology planning",
  "srv.s9.sub2.li3": "Regular review sessions",
  ...
  "hero.eyebrow": "Welcome to ITRB",
  "hero.title1": "Driving Innovation",
  "hero.title2": "Through Technology",
  "hero.subtitle": "Building tomorrow's digital infrastructure, today.",
  ...
  "about.p1":
    "ITRB is a forward-thinking technology company dedicated to delivering cutting-edge IT solutions for businesses of all sizes. Founded on the principles of innovation, reliability, and excellence, we partner with our clients to transform their digital landscape.",
  "about.p2":
    "Our team of experienced engineers, architects, and consultants brings deep expertise across cloud infrastructure, cybersecurity, software development, and digital transformation. We don't just build systems — we build lasting partnerships.",
  ...
  "services.s1.title": "Cloud Infrastructure",
  "services.s1.desc":
    "We design, deploy, and manage scalable cloud environments on AWS, Azure, and GCP. From architecture planning to full migration, our experts ensure your infrastructure is resilient, secure, and cost-optimized.",
  "services.s1.li1": "Cloud Migration & Strategy",
  "services.s1.li2": "DevOps & CI/CD Pipelines",
  "services.s1.li3": "Infrastructure as Code",

  "services.s2.title": "Network Solutions",
  "services.s2.desc":
    "Building robust, high-performance networks that connect your people, systems, and data. Whether it's LAN/WAN design, SD-WAN, or unified communications, we engineer networks built for modern demands.",
  "services.s2.li1": "Enterprise Networking",
  "services.s2.li2": "SD-WAN & VPN Solutions",
  "services.s2.li3": "Network Monitoring & NOC",

  "services.s3.title": "Cybersecurity",
  "services.s3.desc":
    "In an ever-evolving threat landscape, we protect your most critical assets. Our security practice covers risk assessment, compliance, endpoint protection, and 24/7 SOC monitoring to keep your business safe.",
  "services.s3.li1": "Penetration Testing & Audits",
  "services.s3.li2": "SIEM & SOC Operations",
  "services.s3.li3": "Compliance & Risk Management",

  "services.s4.title": "Software Development",
  "services.s4.desc":
    "From concept to deployment, we build custom software that solves real business problems. Our full-stack teams deliver web platforms, internal tools, and system integrations that are fast, maintainable, and built to scale.",
  "services.s4.li1": "Custom Web & Mobile Applications",
  "services.s4.li2": "API Design & System Integration",
  "services.s4.li3": "Legacy System Modernisation",

  "services.s5.title": "IT Consulting & Digital Transformation",
  "services.s5.desc":
    "Navigating digital change requires more than technology — it requires strategy. We work alongside your leadership team to assess your current landscape, define a clear roadmap, and guide execution from the ground up.",
  "services.s5.li1": "Technology Audits & Roadmapping",
  "services.s5.li2": "Digital Transformation Strategy",
  "services.s5.li3": "Vendor Selection & Procurement",

  "org.tag": "Our Team",
  "org.heading": "The People Behind ITRB",
  "org.sub":
    "A diverse team of experts united by a passion for technology and a commitment to excellence.",

  "view.profile.btn": "View Profile",

  "team.name1": "Asen Tsonev",
  "team.name2": "Ekaterina Delcheva",
  "team.name3": "Elena Petrova",
  "team.name4": "Momchil Pakyov",
  "team.name5": "Vladimir Nikolov",
  "team.name7": "Zdravko Zdravkov",
  "team.name8": "Emre Sakal",

  "team.role1": "Head of PMO",
  "team.bio1":
    'Head of PMO with over 15 years of experience leading complex, cross-border projects. Recognized by PMI with the "PMO of the Year" award, he specializes in translating strategic vision into disciplined execution and measurable results for growing organizations.',
  "team.role2": "Chief Financial Officer",
  "team.bio2":
    "Senior accounting professional with 36 years of international experience across diverse industries. With deep expertise in ERP systems, including SAP, she ensures financial precision, operational stability, and disciplined process management in complex environments.",
  "team.role3": "Senior Recruitment Specialist",
  "team.bio3":
    "Senior Recruitment Specialist with over 10 years of experience in technical and executive hiring across Europe. She leads talent acquisition with strategic focus, securing high-impact professionals who strengthen organizational capability and long-term growth.",
  "team.role4": "Head of UX/UI Design",
  "team.bio4":
    "UX and Graphic Designer with over a decade of experience in branding, digital products, and design systems. He combines strategic product thinking with refined visual execution, creating user-centered experiences that strengthen brand identity and drive business impact.",
  "team.role5": "Head of HR",
  "team.bio5":
    "Head of HR with 13+ years of experience in organizational development, talent strategy, and operational structuring. He builds high-performing cultures aligned with business objectives, driving sustainable growth through disciplined people leadership.",
  "team.role6": "Head of Technical & Customer Support",
  "team.bio6":
    "Technical and Customer Support leader with 15 years of experience across SaaS, and financial services. He has led international teams and supported complex product launches, combining operational rigor with strong communication expertise.",
  "team.role7": "IT & Telecommunications Specialist",
  "team.bio7":
    "IT and telecommunications professional with over 20 years experience in UNIX systems, virtualization, and cybersecurity. Formerly an IT Manager at a top Bulgarian construction firm, he now leads the design and maintenance of resilient, scalable IT infrastructures at ITRB, enhancing operational efficiency, reliability, and strategic innovation for clients and teams alike.",
  "team.role8": "Head of Technical Support",
  "team.bio8":
    "With over five years of experience in operations and team management, I serve as Head of Technical Support at ITRB. I specialize in team leadership, performance management, and process optimization, overseeing recruitment, training, coaching, and KPI tracking to ensure efficient workflows, high service quality, strong team performance, and continuous employee development.",
  ...
  "footer.copy": "© 2026 ITRB. All rights reserved.",
